function   mainn = global_alignment_SPT(Tx_west, Ty_west, Tx_north, Ty_north,...
...
tic
% Compute Shortest Path Spanning Tree (SPT)
...
imwrite(I,sprintf('%s_stitching_result_Optimization_%s_SPT%s',dataset_name,Optimization, img_type))
